...
TAXONOMY_RULES = [
    ...
    (r"deepfake|voice clone|voice cloning|impersonat", ["LLM09"], ["ASI09"], ["AML.T0048"], "other"),
    ...
    (r"rce|remote code|command injection|sandbox escape", ["LLM05"], ["ASI05"], ["AML.T0050"], "rce"),
    (r"ssrf", ["LLM05"], ["ASI02"], ["AML.T0049"], "ssrf"),
    (r"supply chain", ["LLM03"], ["ASI04"], ["AML.T0010"], "supply-chain"),
    ...
    (r"poisoning|backdoor", ["LLM04"], ["ASI06"], ["AML.T0020", "AML.T0018"], "model-poisoning"),
    (r"hallucinat", ["LLM09"], [], ["AML.T0058"], "other"),
    (r"misinform|disinform|propaganda|influence operation", ["LLM09"], [], ["AML.T0048"], "other"),
    (r"election", ["LLM09"], [], ["AML.T0048"], "other"),
    (r"agent.*hijack|agent goal", ["LLM06"], ["ASI01"], ["AML.T0051"], "agent-hijack"),
    (r"tool.*misuse|tool.*abuse|plugin.*compromise", ["LLM06"], ["ASI02"], ["AML.T0053"], "tool-abuse"),
    (r"memory.*poison|context.*poison", ["LLM04"], ["ASI06"], ["AML.T0066"], "memory-poisoning"),
    (r"chatbot|virtual assistant", [], [], [], "other"),
    (r"copilot|autopilot", ["LLM06"], ["ASI01"], [], "other"),
    (r"surveillance|facial recogn|face recogn", [], [], ["AML.T0048"], "other"),
    (r"csam|child sexual", ["LLM09"], [], ["AML.T0048"], "other"),
