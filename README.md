...
A consolidated, machine-readable index of **[<!-- stats:incident_count -->13,119<!-- /stats:incident_count --> GenAI and agentic AI security incidents](https://emmanuelgjr.github.io/genai_incidents/)** (see the live count in the badge above), each mapped to:
