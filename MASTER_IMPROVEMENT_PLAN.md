...
- **Phase 1 — "Honest" (→ release v2.7.0).** Docs sync'd, licensing chain documented, overclaims removed, quick wins shipped, **second annotator recruitment started (WS5-T2a)**. *Exit criteria:* WS0-T2/T5/T6, WS6-T2, WS3-T5 (decision made) done; WS0-T1 has zero blank rows — every row resolved or carrying pending-outreach status with dates; WS5-T2a outreach sent.
