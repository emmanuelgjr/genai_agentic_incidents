---
title: "INC-10447 — In the Linux kernel, the following vulnerability has been resolved: net: vlan: don't propagate flags on open With the device instance lock, there is now a possibility of a dea..."
layout: incident
permalink: /incident/INC-10447.html
incident_id: INC-10447
year: 2025
severity: Medium
description_preview: "In the Linux kernel, the following vulnerability has been resolved: net: vlan: don't propagate flags on open With the device instance lock, there is now a possibility of a deadlock: [ 1.211455] ======"
tags_str: "cve, nvd"
---

{% raw %}
<div class="incident-anchor" id="inc-10447" markdown="1">

### INC-10447  [↗](/incident/INC-10447.html)

**In the Linux kernel, the following vulnerability has been resolved: net: vlan: don't propagate flags on open With the device instance lock, there is now a possibility of a dea...**  
...
**References:**
- [NVD](https://nvd.nist.gov/vuln/detail/CVE-2025-23163) _(advisory)_
- [416baaa9-dc9f-4396-8d5f-8c081fb06d67](https://git.kernel.org/stable/c/27b918007d96402aba10ed52a6af8015230f1793) _(patch)_
- [416baaa9-dc9f-4396-8d5f-8c081fb06d67](https://git.kernel.org/stable/c/299d7d27af6b5844cda06a0fdfa635705e1bc50f) _(patch)_
- [416baaa9-dc9f-4396-8d5f-8c081fb06d67](https://git.kernel.org/stable/c/523fa0979d842443aa14b80002e45b471cbac137) _(patch)_
- [416baaa9-dc9f-4396-8d5f-8c081fb06d67](https://git.kernel.org/stable/c/538b43aa21e3b17c110104efd218b966d2eda5f8) _(patch)_
- [416baaa9-dc9f-4396-8d5f-8c081fb06d67](https://git.kernel.org/stable/c/53fb25e90c0a503a17c639341ba5e755cb2feb5c) _(patch)_
