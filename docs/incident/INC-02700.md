...
tags_str: "agentic, csrf, cve, ghsa, inspector, mcp, modelcontextprotocol-inspector, nvd, rce"
---
...
- [GHSA-7f8r-222p-6f5g](https://github.com/advisories/GHSA-7f8r-222p-6f5g) _(advisory)_

**Tags:** `agentic`, `csrf`, `cve`, `ghsa`, `inspector`, `mcp`, `modelcontextprotocol-inspector`, `nvd`, `rce`
