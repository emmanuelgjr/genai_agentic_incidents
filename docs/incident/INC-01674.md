---
title: "INC-01674 — PraisonAIAgents — Prompt Injection (CVE-2026-40111)"
layout: incident
permalink: /incident/INC-01674.html
incident_id: INC-01674
year: 2026
severity: High
description_preview: "PraisonAIAgents is a multi-agent teams system. Prior to 1.5.128, he memory hooks executor in praisonaiagents passes a user-controlled command string directly to subprocess.run() with shell=True at src"
tags_str: "cve, ghsa, nvd, praisonaiagents, prompt-injection"
---

<div class="incident-anchor" id="inc-01674" markdown="1">

### INC-01674  [↗](/incident/INC-01674.html)

**PraisonAIAgents — Prompt Injection (CVE-2026-40111)**  
...
**References:**
- [NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-40111) _(advisory)_
- [security-advisories@github.com](https://github.com/MervinPraison/PraisonAI/security/advisories/GHSA-v7px-3835-7gjx) _(vendor)_
- [GHSA-v7px-3835-7gjx](https://github.com/advisories/GHSA-v7px-3835-7gjx) _(advisory)_
