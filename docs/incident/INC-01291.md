---
title: "INC-01291 — LangChain and LlamaIndex RCE — agent code execution via prompt injection"
layout: incident
...
tags_str: "agent-framework, code-execution, cve, langchain, llamaindex, palchain, prompt-injection, rce"
---
