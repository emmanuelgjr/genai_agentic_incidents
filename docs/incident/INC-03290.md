...
tags_str: "cloudflare-workers-oauth-provider, cve, ghsa, nvd"
---
...
- [GHSA-4pc9-x2fx-p7vj](https://github.com/advisories/GHSA-4pc9-x2fx-p7vj) _(advisory)_
- [https://github.com/cloudflare/workers-oauth-provider/security/advisories/GHSA-4pc9-x2fx-p7vj](https://github.com/cloudflare/workers-oauth-provider/security/advisories/GHSA-4pc9-x2fx-p7vj) _(reference)_
- [GHSA-7cp4-jw97-3rc2](https://github.com/advisories/GHSA-7cp4-jw97-3rc2) _(advisory)_

**Tags:** `cloudflare-workers-oauth-provider`, `cve`, `ghsa`, `nvd`
