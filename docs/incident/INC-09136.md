---
title: "INC-09136 — The Query Monitor plugin for WordPress has Reflected Cross-Site Scripting via Request URI"
layout: incident
permalink: /incident/INC-09136.html
incident_id: INC-09136
year: 2026
severity: Medium
description_preview: "### Impact The Query Monitor plugin for WordPress is vulnerable to Reflected Cross-Site Scripting via the `$_SERVER['REQUEST_URI']` parameter in all versions up to, and including, 3.20.3 due to insuff"
tags_str: "cve, ghsa, johnbillion-query-monitor, xss"
---

{% raw %}
<div class="incident-anchor" id="inc-09136" markdown="1">

### INC-09136  [↗](/incident/INC-09136.html)
...
**Affected:** composer/johnbillion/query-monitor  
**Attack vector:** `xss`  
...
**References:**
- [NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-4267) _(advisory)_
- [GHSA-2xr4-chcf-vmvf](https://github.com/advisories/GHSA-2xr4-chcf-vmvf) _(advisory)_
- [https://github.com/johnbillion/query-monitor/security/advisories/GHSA-2xr4-chcf-vmvf](https://github.com/johnbillion/query-monitor/security/advisories/GHSA-2xr4-chcf-vmvf) _(reference)_

**Tags:** `cve`, `ghsa`, `johnbillion-query-monitor`, `xss`
