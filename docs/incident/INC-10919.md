---
title: "INC-10919 — RobotsAndPencils go-saml authentication bypass vulnerability"
layout: incident
permalink: /incident/INC-10919.html
incident_id: INC-10919
year: 2024
severity: High
description_preview: "RobotsAndPencils go-saml, a SAML client library written in Go, contains an authentication bypass vulnerability in all known versions. This is due to how the `xmlsec1` command line tool is called inter"
tags_str: "auth-bypass, cve, ghsa, github.com-robotsandpencils-go-saml"
---

{% raw %}
<div class="incident-anchor" id="inc-10919" markdown="1">

### INC-10919  [↗](/incident/INC-10919.html)
...
**References:**
- [NVD](https://nvd.nist.gov/vuln/detail/CVE-2023-48703) _(advisory)_
- [GHSA-6h53-q94j-348w](https://github.com/advisories/GHSA-6h53-q94j-348w) _(advisory)_
- [https://securitylab.github.com/advisories/GHSL-2023-121_go-saml__archived_](https://securitylab.github.com/advisories/GHSL-2023-121_go-saml__archived_) _(reference)_

**Tags:** `auth-bypass`, `cve`, `ghsa`, `github.com-robotsandpencils-go-saml`
