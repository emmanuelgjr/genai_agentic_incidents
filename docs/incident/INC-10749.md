---
title: "INC-10749 — smol-toml has a Denial of Service via malicious TOML document using deeply nested inline tables"
layout: incident
permalink: /incident/INC-10749.html
incident_id: INC-10749
year: 2024
severity: Medium
description_preview: "### Summary An attacker can send a maliciously crafted TOML to cause the parser to crash because of a stack overflow caused by a deeply nested inline structure. A similar problem occurs when attemptin"
tags_str: "ghsa, smol-toml"
---

{% raw %}
<div class="incident-anchor" id="inc-10749" markdown="1">

### INC-10749  [↗](/incident/INC-10749.html)
...
**References:**
- [GHSA-pqhp-25j4-6hq9](https://github.com/advisories/GHSA-pqhp-25j4-6hq9) _(advisory)_
- [https://github.com/squirrelchat/smol-toml/security/advisories/GHSA-pqhp-25j4-6hq9](https://github.com/squirrelchat/smol-toml/security/advisories/GHSA-pqhp-25j4-6hq9) _(reference)_
- [https://github.com/squirrelchat/smol-toml/commit/405108ba090f0fc78f99aa2f0d6721e499b0ff27](https://github.com/squirrelchat/smol-toml/commit/405108ba090f0fc78f99aa2f0d6721e499b0ff27) _(reference)_
