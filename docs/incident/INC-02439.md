...
tags_str: "anthropic-ai-claude-code, cve, ghsa, nvd"
---
...
- [GHSA-9f65-56v6-gxw7](https://github.com/advisories/GHSA-9f65-56v6-gxw7) _(advisory)_

**Tags:** `anthropic-ai-claude-code`, `cve`, `ghsa`, `nvd`
