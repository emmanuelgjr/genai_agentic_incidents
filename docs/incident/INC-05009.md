...
tags_str: "cve, dependencytrack-frontend, ghsa, nvd, xss"
---
...
- [GHSA-c33w-pm52-mqvf](https://github.com/advisories/GHSA-c33w-pm52-mqvf) _(advisory)_
- [https://github.com/showdownjs/showdown/wiki/Markdown's-XSS-Vulnerability-(and-how-to-mitigate-it)](https://github.com/showdownjs/showdown/wiki/Markdown's-XSS-Vulnerability-(and-how-to-mitigate-it)) _(reference)_

**Tags:** `cve`, `dependencytrack-frontend`, `ghsa`, `nvd`, `xss`
