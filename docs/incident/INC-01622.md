...
tags_str: "command-injection, cve, ghsa, nvd, paperclipai-server"
---
...
- [GHSA-265w-rf2w-cjh4](https://github.com/advisories/GHSA-265w-rf2w-cjh4) _(advisory)_

**Tags:** `command-injection`, `cve`, `ghsa`, `nvd`, `paperclipai-server`
