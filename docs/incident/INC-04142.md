...
tags_str: "a2a, agent, agentdojo, benchmark, black-box, cascade, corpus, cross-agent, embedding-manipulation, knowledge-base, multi-agent, neurips-2024, prompt-injection, propagation, rag-poisoning, red-team, research-demonstrated, retrieval, usenix-2025, worm"
---
...
- [AgentDojo repo](https://github.com/ethz-spylab/agentdojo) _(research)_

**Tags:** `a2a`, `agent`, `agentdojo`, `benchmark`, `black-box`, `cascade`, `corpus`, `cross-agent`, `embedding-manipulation`, `knowledge-base`, `multi-agent`, `neurips-2024`, `prompt-injection`, `propagation`, `rag-poisoning`, `red-team`, `research-demonstrated`, `retrieval`, `usenix-2025`, `worm`
