...
tags_str: "cve, ghsa, mesop, nvd, prompt-injection"
---
...
- [GHSA-f3mf-hm6v-jfhh](https://github.com/advisories/GHSA-f3mf-hm6v-jfhh) _(advisory)_

**Tags:** `cve`, `ghsa`, `mesop`, `nvd`, `prompt-injection`
