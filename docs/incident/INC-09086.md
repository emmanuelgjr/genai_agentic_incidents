---
title: "INC-09086 — dd-trace-java: Unsafe deserialization in RMI instrumentation may lead to remote code execution"
layout: incident
permalink: /incident/INC-09086.html
incident_id: INC-09086
year: 2026
severity: Critical
description_preview: "In versions of dd-trace-java prior to 1.60.3, the RMI instrumentation registered a custom endpoint that deserialized incoming data without applying serialization filters. On JDK version 16 and earlier"
tags_str: "com.datadoghq-dd-java-agent, cve, deserialization, ghsa"
---

<div class="incident-anchor" id="inc-09086" markdown="1">

### INC-09086  [↗](/incident/INC-09086.html)
...
**Affected:** maven/com.datadoghq:dd-java-agent  
...
**References:**
- [NVD](https://nvd.nist.gov/vuln/detail/CVE-2026-33728) _(advisory)_
- [GHSA-579q-h82j-r5v2](https://github.com/advisories/GHSA-579q-h82j-r5v2) _(advisory)_
- [https://github.com/DataDog/dd-trace-java/security/advisories/GHSA-579q-h82j-r5v2](https://github.com/DataDog/dd-trace-java/security/advisories/GHSA-579q-h82j-r5v2) _(reference)_
- [https://github.com/DataDog/dd-trace-java/releases/tag/v1.60.3](https://github.com/DataDog/dd-trace-java/releases/tag/v1.60.3) _(reference)_

**Tags:** `com.datadoghq-dd-java-agent`, `cve`, `deserialization`, `ghsa`
